...
public class ManagerPanel {
    ...
    public void userFarash(ActionEvent actionEvent) throws IOException {
        Main m = new Main();
        m.changeScene("managerPanel.fxml");
    }

    public void userShahidul(ActionEvent actionEvent) throws IOException {
        Main m = new Main();
        m.changeScene("managerPanel.fxml");
    }

    public void userKhalilur(ActionEvent actionEvent) throws IOException {
        Main m = new Main();
        m.changeScene("managerPanel.fxml");
    }
}
